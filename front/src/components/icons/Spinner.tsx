...
export const Spinner = () => {
  ...
  return (
    <motion.svg
      ...
      height="24"
      viewBox="0 0 24 24"
      initial={{ scale: 0, rotate: -180 * options.direction }}
      animate={{ scale: 1, rotate: 360 * options.direction }}
      transition={{ opacity: { duration: 0.5 }, rotate: { repeat: Infinity, duration: 10, ease: 'linear' } }}
    >
      <motion.path
